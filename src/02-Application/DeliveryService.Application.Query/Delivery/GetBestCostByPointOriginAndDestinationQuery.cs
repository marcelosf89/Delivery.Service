...
{
    public class GetBestCostByPointOriginAndDestinationQuery : IQuery<GetBestCostByPointOriginAndDestinationQueryRequest, IEnumerable<Route>>
    {
        private readonly IRouteData _routeData;

        public GetBestCostByPointOriginAndDestinationQuery(IRouteData routeData)
        {
            _routeData = routeData;
        }

        public IEnumerable<Route> Execute(GetBestCostByPointOriginAndDestinationQueryRequest request)
        {
